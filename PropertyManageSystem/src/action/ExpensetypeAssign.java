...
public class ExpensetypeAssign extends ActionSupport{
	...
	public String fkfind(){
		...
		for (Expensetype expensetype : list1) {
			s+="&lt;option value='"+expensetype.getExpenseId()+"'&gt;"+expensetype.getExpensename()+"&lt;/option&gt;";
		}
		this.str=s;
		return "fkfind";
	...
	public String fkfindbyid(){
		List<Expensetype> list1= new ArrayList();
		
		Expensetype expensetype=expensetypeService.edit(Integer.parseInt(expenseId));
		list1=expensetypeService.findall();
		String s="";
		for(Expensetype expensetype2:list1){
			if(expensetype2!=null&&expensetype!=null&&expensetype2.getExpenseId()==Integer.parseInt(expenseId)){
				s+="&lt;option value='"+expensetype2.getExpenseId()+"' selected &gt;"+expensetype2.getExpensename()+"&lt;/option&gt;";
			}
			else{
				s+="&lt;option value='"+expensetype2.getExpenseId()+"' &gt;"+expensetype2.getExpensename()+"&lt;/option&gt;";
			}
		}
